...
const Stickers = ({ products }) => {
  return (
    <>
      <Head>
        <title>WearnCode Stickers</title>
      </Head>
      <section className="text-gray-600 body-font min-h-screen">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center">
            {Object.keys(products).length === 0 && <p className='px-4'>Sorry, all the Stickers are currently out of stock. Now stock coming soon. Stay Tuned!</p>}
